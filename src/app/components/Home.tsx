...
export function Home() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-100 via-white to-red-50 text-slate-900">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <Card key={index} className="hover:border-red-300 transition-all hover:shadow-red-100 hover:shadow-lg">
                  <CardHeader>
