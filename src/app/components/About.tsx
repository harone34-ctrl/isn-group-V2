        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="text-center hover:border-red-300 transition-all">
                  <CardContent className="pt-6">
                    <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Icon className="h-8 w-8 text-red-600" />
                    </div>
                    <h3 className="font-bold text-xl mb-2 text-slate-900">{value.title}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-gray-100 rounded-xl p-8 border border-gray-300 hover:border-red-300 transition-all"
              >
                <div className="text-5xl font-bold text-emerald-500/20 mb-4">{item.number}</div>
                <h3 className="text-2xl font-bold text-slate-900 mb-4">{item.pillar}</h3>
                <p className="text-slate-600 mb-4">{item.description}</p>
                <p className="text-slate-500 text-sm border-t border-gray-300 pt-4">{item.detail}</p>
              </div>
            ))}
          </div>
        </div>
