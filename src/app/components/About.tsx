        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="bg-[#0b132b] text-center hover:border-amber-500/40 transition-all">
                  <CardContent className="pt-6">
                    <div className="w-16 h-16 bg-amber-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Icon className="h-8 w-8 text-amber-500" />
                    </div>
                    <h3 className="font-bold text-xl mb-2 text-amber-400">{value.title}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-[#030712] rounded-xl p-8 border border-amber-500/20 hover:border-amber-500/40 transition-all"
              >
                <div className="text-5xl font-bold text-amber-500/20 mb-4">{item.number}</div>
                <h3 className="text-2xl font-bold text-amber-400 mb-4">{item.pillar}</h3>
                <p className="text-slate-300 mb-4">{item.description}</p>
                <p className="text-slate-300 text-sm border-t border-amber-500/20 pt-4">{item.detail}</p>
              </div>
            ))}
          </div>
        </div>
