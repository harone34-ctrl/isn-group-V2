...
export function Services() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="bg-[#0a4d92] text-white py-20">
              ...
              return (
                ...
                >
                  <div className={isEven ? "" : "md:col-start-2"}>
                    <div className="w-16 h-16 bg-[#0a4d92]/10 rounded-lg flex items-center justify-center mb-6">
                      <Icon className="h-8 w-8 text-[#0a4d92]" />
                    </div>
                    <h2 className="text-3xl font-bold mb-4 text-neutral-900">{service.title}</h2>
                    <p className="text-xl text-neutral-600 mb-6">{service.description}</p>

                    <div className="space-y-3 mb-8">
                      {service.features.map((feature, idx) => (
                        <div key={idx} className="flex items-start gap-3">
                          <CheckCircle className="h-5 w-5 text-[#0a4d92] flex-shrink-0 mt-0.5" />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              <Badge className="mb-4 bg-[#0a4d92]/20 text-[#0a4d92] border border-[#0a4d92]/30">
                Haute Performance
              </Badge>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-[#0a4d92]/40 transition-all"
                  >
                    <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0" />
                    <div>
                      <span className="font-mono font-bold text-[#0a4d92]">{proto.name}</span>
                      <p className="text-neutral-600 text-sm mt-1">{proto.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#0a4d92]/10 border border-[#0a4d92]/30 flex items-center justify-center flex-shrink-0">
                      <span className="text-[#0a4d92] text-xs font-bold">{idx + 1}</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <Badge className="mb-4 bg-amber-100 text-amber-700 border border-amber-300">
              Éco-efficience &amp; Maintenance Préventive
            </Badge>
          ...
          {/* Constat économique */}
          <div className="max-w-4xl mx-auto mb-14 p-6 bg-amber-50 border border-amber-200 rounded-xl">
            <div className="flex items-start gap-4">
              <AlertTriangle className="h-6 w-6 text-amber-700 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-bold text-amber-700 mb-2">Contexte économique 2024–2026</h3>
                <p className="text-neutral-600 leading-relaxed">
                  ...
                  <span className="text-neutral-900 font-medium">DDR5 de 40 à 60 %</span> et des{" "}
                  <span className="text-neutral-900 font-medium">SSD NVMe de 50 à 80 %</span> en deux ans.
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {/* Thermique */}
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-[#0a4d92]/40 transition-all flex flex-col">
              <div className="w-12 h-12 bg-[#0a4d92]/10 rounded-lg flex items-center justify-center mb-4">
                <Thermometer className="h-6 w-6 text-[#0a4d92]" />
              </div>
              <h3 className="font-bold text-neutral-900 text-lg mb-2">Optimisation thermique chirurgicale</h3>
              ...
              <ul className="space-y-2.5 mt-auto">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-neutral-600">
                    <CheckCircle className="h-4 w-4 text-[#0a4d92] flex-shrink-0 mt-0.5" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-[#0a4d92]/40 transition-all flex flex-col">
              <div className="w-12 h-12 bg-[#0a4d92]/10 rounded-lg flex items-center justify-center mb-4">
                <HardDrive className="h-6 w-6 text-[#0a4d92]" />
              </div>
              <h3 className="font-bold text-neutral-900 text-lg mb-2">Prolongation de la durée de vie des SSD</h3>
              <p className="text-neutral-600 text-sm mb-4 leading-relaxed">
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-[#0a4d92]/40 transition-all flex flex-col">
              <div className="w-12 h-12 bg-[#0a4d92]/10 rounded-lg flex items-center justify-center mb-4">
                <Activity className="h-6 w-6 text-[#0a4d92]" />
              </div>
              <h3 className="font-bold text-neutral-900 text-lg mb-2">Audit de stabilité électrique &amp; matériel</h3>
              <p className="text-neutral-600 text-sm mb-4 leading-relaxed">
              ...
              <ul className="space-y-2.5 mt-auto">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-neutral-600">
                    <span className="font-mono text-xs text-[#0a4d92] bg-[#0a4d92]/10 px-1.5 py-0.5 rounded flex-shrink-0 mt-0.5">
                      {item.tool}
                    </span>
                    <span>{item.desc}</span>
                  </li>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalServices.map((service, index) => {
              const Icon = service.icon;
              return (
                <Card key={index} className="bg-white border border-gray-200 hover:border-[#0a4d92]/40 transition-all">
                  <CardHeader>
                    <div className="w-12 h-12 bg-[#0a4d92]/10 rounded-lg flex items-center justify-center mb-4">
