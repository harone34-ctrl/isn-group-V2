    ...
    <div>
              ...
              return (
                ...
                >
                  <div className={isEven ? "" : "md:col-start-2"}>
                    <div className="w-16 h-16 bg-amber-500/10 rounded-lg flex items-center justify-center mb-6">
                      <Icon className="h-8 w-8 text-amber-500" />
                    </div>
                    <h2 className="text-3xl font-bold mb-4 text-amber-400">{service.title}</h2>
      ...
      <section className="py-20 bg-[#030712]">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              <Badge className="mb-4 bg-amber-500/20 text-amber-500 border border-amber-500/30">
                Haute Performance
              </Badge>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-4 p-4 bg-[#0b132b] rounded-lg border border-amber-500/20 hover:border-amber-500/40 transition-all"
                  >
                    <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0" />
                    <div>
                      <span className="font-mono font-bold text-amber-500">{proto.name}</span>
                      <p className="text-slate-300 text-sm mt-1">{proto.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-[#0b132b] rounded-xl p-8 border border-amber-500/20">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          {/* Constat économique */}
          <div className="max-w-4xl mx-auto mb-14 p-6 bg-amber-900/20 border border-amber-500/30 rounded-xl">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  <span className="text-amber-400 font-medium">DDR5 de 40 à 60 %</span> et des{" "}
                  <span className="text-amber-400 font-medium">SSD NVMe de 50 à 80 %</span> en deux ans.
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {/* Thermique */}
            <div className="p-6 bg-[#030712] rounded-xl border border-amber-500/20 hover:border-amber-500/40 transition-all flex flex-col">
              <div className="w-12 h-12 bg-amber-500/10 rounded-lg flex items-center justify-center mb-4">
                <Thermometer className="h-6 w-6 text-amber-500" />
              </div>
              <h3 className="font-bold text-amber-400 text-lg mb-2">Optimisation thermique chirurgicale</h3>
            ...
            <div className="p-6 bg-[#030712] rounded-xl border border-amber-500/20 hover:border-amber-500/40 transition-all flex flex-col">
              ...
              <h3 className="font-bold text-amber-400 text-lg mb-2">Prolongation de la durée de vie des SSD</h3>
              <p className="text-slate-300 text-sm mb-4 leading-relaxed">
            ...
            <div className="p-6 bg-[#030712] rounded-xl border border-amber-500/20 hover:border-amber-500/40 transition-all flex flex-col">
              ...
              <h3 className="font-bold text-amber-400 text-lg mb-2">Audit de stabilité électrique &amp; matériel</h3>
              <p className="text-slate-300 text-sm mb-4 leading-relaxed">
              ...
              <ul className="space-y-2.5 mt-auto">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-slate-300">
                    <span className="font-mono text-xs text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded flex-shrink-0 mt-0.5">
                      {item.tool}
                    </span>
                    <span>{item.desc}</span>
                  </li>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalServices.map((service, index) => {
              const Icon = service.icon;
              return (
                <Card key={index} className="bg-[#030712] border border-amber-500/20 hover:border-amber-500/40 transition-all">
                  <CardHeader>
                    <div className="w-12 h-12 bg-amber-500/10 rounded-lg flex items-center justify-center mb-4">
